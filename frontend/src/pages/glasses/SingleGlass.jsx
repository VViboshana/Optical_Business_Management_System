  ...
  return (
    <div className="max-w-lg shadow-md p-5">
            ...
            <div className=''>
                ...
                <div className='mb-5'>
                    <p className="text-gray-700 mb-2"><strong>Price: $</strong> {glass.newPrice || 'admin'}</p>
                    <p className="text-gray-700 mb-4">
                        <strong>Available from:</strong> {new Date(glass?.createdAt).toLocaleDateString()}
                    </p>
                    <p className="text-gray-700 mb-4 capitalize">
                        <strong>Category:</strong> {glass?.category}
                    </p>
                    <p className="text-gray-700"><strong>Description:</strong> {glass.description}</p>
                </div>

                <button onClick={() => handleAddToCart(glass)} className="btn-primary px-6 space-x-1 flex items-center gap-1 ">
