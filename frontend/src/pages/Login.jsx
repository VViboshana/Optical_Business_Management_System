...
const Login = () => {
  ...
  return (
    ...
    sm:px-0 bg-gradient-to-br from-blue-200 to-puple-400'>
      ...
      text-indigo-300 text-sm'>
        ...
        <form>
          {state === 'Sign Up' && (
            <div className='md-4 flex items-center gap-3 w-full px-5 py-2.5 
        ...
        : (
          <p className='text-gray-400 text-center text-xs mt-4'>Don't have 
          an account?{' '}
