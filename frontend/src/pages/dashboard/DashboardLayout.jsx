...
function DashboardLayout() {
  ...
  return (
    ...
    <aside className="hidden sm:flex sm:flex-col">
      <a href="/" className="inline-flex items-center justify-center h-20 w-20 bg-primary hover:bg-purple-500 focus:bg-purple-500">
      ...
      <div className="flex-grow flex flex-col justify-between text-gray-500 bg-gray-800">
        <nav className="flex flex-col mx-4 my-6 space-y-4">
          ...
          <Link to="/dashboard" className="inline-flex items-center justify-center py-3 text-primary bg-white rounded-lg">
          ...
          <Link to="/dashboard/add-new-book" className="inline-flex items-center justify-center py-3 hover:text-gray-400 hover:bg-gray-700 focus:text-gray-400 focus:bg-gray-700 rounded-lg">
            <span className="sr-only">Add a Glass</span>
        ...
        <div className="flex flex-shrink-0 items-center ml-auto">
          <button className="inline-flex items-center p-2 hover:bg-gray-100 focus:bg-gray-100 rounded-lg">
            ...
            <div className="hidden md:flex md:flex-col md:items-end md:leading-tight">
              <span className="font-semibold">Kumod De Silva</span>
              <span className="text-sm text-gray-600">Silver-User</span>
            </div>
      ...
      <main className="p-6 sm:p-10 space-y-6 ">
        <div className="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between">
          <div className="mr-6">
            ...
            <h2 className="text-gray-600 ml-0.5">Glasses Inventory</h2>
          </div>
          <div className="flex flex-col md:flex-row items-start justify-end -mb-3">
            <Link to="/dashboard/manage-glasses" className="inline-flex px-5 py-3 text-primary hover:text-white focus:text-purple-700 hover:bg-primary focus:bg-primary border border-primary rounded-md mb-3 transition duration-300 ease-in-out">
              <svg aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="flex-shrink-0 h-5 w-5 -ml-1 mt-0.5 mr-2">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
              </svg>
              Manage Glasses
            </Link>
            <Link to="/dashboard/add-new-glass" className="inline-flex px-5 py-3 text-white bg-primary hover:bg-primary-dark focus:bg-primary rounded-md ml-6 mb-3 transition duration-300 ease-in-out">
