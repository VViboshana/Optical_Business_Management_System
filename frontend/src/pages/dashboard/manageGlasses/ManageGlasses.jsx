...
import { useDeleteGlassMutation, useFetchAllGlassesQuery } from '../../../redux/features/glasses/glassApi';
...
const ManageGlasses = () => {
    ...
    const handleEditClick = (id) => {
        navigate(`dashboard/edit-glass/${id}`);
    };
  return (
        ...
        <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded ">
            <div className="rounded-t mb-0 px-4 py-3 border-0">
                <div className="flex flex-wrap items-center">
                    <div className="relative w-full px-4 max-w-full flex-grow flex-1">
                        <h3 className="font-semibold text-base text-blueGray-700">Frames in Stock</h3>
                    </div>
            ...
            <div className="block w-full overflow-x-auto">
                <table className="items-center bg-transparent w-full border-collapse ">
                    ...
                    <tbody>
                        {
                            glasses && glasses.map((glass, index) => (
                                <tr key={index}>
                                ...
                                <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 space-x-4">
                                    ...
                                    <Link to={`/dashboard/edit-glass/${glass._id}`} className="font-medium text-indigo-600 hover:text-indigo-700 mr-2 hover:underline underline-offset-2">
                                        Edit
                                    </Link>
                                    <button 
